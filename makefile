...
all: main.exe quad.o window.o FileManager.o OrtographicCamera.o Shader.o
.PHONY: all
main.exe:main.cpp quad.o window.o FileManager.o OrtographicCamera.o Shader.o
	g++  -o main.exe  main.cpp quad.o window.o FileManager.o OrtographicCamera.o Shader.o -I ./libs/ -L ./libs/ $(LIBRERIAS)
